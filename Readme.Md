Name: Azry Syafiqah Mohamad Nasir
...
Create a Deployment named broken-service-deployment with 2 replicas using the nginx:1.21 image. The Deployment should expose port 80.a
